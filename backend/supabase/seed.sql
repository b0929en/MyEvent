...
-- Events
INSERT INTO events (event_id, event_name, event_date, event_description, event_venue, start_time, end_time, end_date, capacity, category, registered_count, event_request_id, committee_members, registration_deadline, gallery) VALUES
('20000000-0000-0000-0000-000000000001', 'USM Sports Carnival 2025', '2026-02-15', 'Annual sports carnival featuring various competitive sports including football, basketball, badminton, and track & field events. Join us for a week of athletic excellence!', 'USM Main Campus Sports Complex', '08:00', '18:00', '2026-02-22', 500, 'sport', 342, '50000000-0000-0000-0000-000000000001', '[{"name": "Ahmad Ibrahim", "matricNumber": "165432", "position": "Head of Logistics", "email": "jm@student.usm.my", "faculty": "Computer Sciences"}]'::jsonb, '2026-02-13', '{}'),
('20000000-0000-0000-0000-000000000002', 'HackUSM 2025 - National Hackathon', '2026-03-01', '48-hour national hackathon bringing together the brightest minds to solve real-world problems using technology. Prizes worth RM50,000!', 'School of Computer Sciences, USM', '09:00', '17:00', '2026-03-03', 200, 'competition', 156, '50000000-0000-0000-0000-000000000002', '[]'::jsonb, '2026-02-25', '{}'),
('20000000-0000-0000-0000-000000000003', 'Introduction to Arduino Workshop', '2026-01-20', 'Beginner-friendly workshop covering Arduino basics, circuit design, and simple robotics projects. All materials provided!', 'Engineering Lab 3, USM', '14:00', '17:00', '2026-01-20', 50, 'workshop', 48, '50000000-0000-0000-0000-000000000003', '[]'::jsonb, '2026-01-18', '{}'),
('20000000-0000-0000-0000-000000000004', 'National Debate Championship 2025', '2026-04-10', 'Premier debating competition featuring teams from universities across Malaysia. Topics cover current affairs, policy, and philosophy.', 'USM Dewan Tuanku Syed Putra', '09:00', '18:00', '2026-04-12', 300, 'competition', 87, '50000000-0000-0000-0000-000000000004', '[]'::jsonb, '2026-04-05', '{}'),
('20000000-0000-0000-0000-000000000005', 'Career Fair: Tech Industry Insights', '2026-02-05', 'Connect with leading tech companies, learn about career opportunities, and attend industry talks by professionals.', 'Dewan Utama USM', '10:00', '16:00', '2026-02-05', 400, 'talk', 312, '50000000-0000-0000-0000-000000000005', '[]'::jsonb, '2026-02-03', '{}'),
('20000000-0000-0000-0000-000000000006', 'Futsal Tournament - Inter-Faculty', '2026-01-25', 'Exciting inter-faculty futsal tournament. Form your team and compete for the championship trophy!', 'USM Indoor Sports Hall', '18:00', '22:00', '2026-01-28', 150, 'sport', 120, '50000000-0000-0000-0000-000000000006', '[]'::jsonb, '2026-01-20', '{}'),
('20000000-0000-0000-0000-000000000007', 'Bridge Building Competition 2025', '2026-03-10', 'Test your engineering skills by building the strongest bridge using popsicle sticks.', 'Engineering School Hall', '09:00', '16:00', '2026-03-10', 100, 'competition', 45, '50000000-0000-0000-0000-000000000007', '[]'::jsonb, '2026-03-05', '{}'),
('20000000-0000-0000-0000-000000000008', 'Cultural Night 2025', '2026-04-20', 'A night of mesmerizing performances celebrating our diverse cultures.', 'Dewan Budaya', '19:00', '23:00', '2026-04-20', 800, 'cultural', 200, '50000000-0000-0000-0000-000000000008', '[]'::jsonb, '2026-04-15', '{}'),
('20000000-0000-0000-0000-000000000009', 'Programming Clinic: Python Basics', '2024-11-20', 'Learn the basics of Python programming in this hands-on workshop.', 'Computer Lab 1', '10:00', '13:00', '2024-11-20', 30, 'workshop', 30, '50000000-0000-0000-0000-000000000009', '[]'::jsonb, '2024-11-18', '{}'),
('20000000-0000-0000-0000-000000000010', 'AI & Future Tech Talk', '2026-03-15', 'Explore the future of artificial intelligence.', 'DK 1', '10:00', '12:00', '2026-03-15', 200, 'talk', 180, '50000000-0000-0000-0000-000000000011', '[]'::jsonb, '2026-03-10', '{}'),
('20000000-0000-0000-0000-000000000011', 'Badminton Open 2025', '2026-02-28', 'Who will be the champion?', 'USM Sports Complex', '08:00', '18:00', '2026-03-01', 100, 'sport', 95, '50000000-0000-0000-0000-000000000012', '[]'::jsonb, '2026-02-25', '{}'),
('20000000-0000-0000-0000-000000000012', 'Robotics Showcase', '2026-04-05', 'See the latest student robotics projects.', 'Foyer SKK', '10:00', '16:00', '2026-04-05', 300, 'workshop', 250, '50000000-0000-0000-0000-000000000013', '[]'::jsonb, '2026-04-01', '{}'),
('20000000-0000-0000-0000-000000000013', 'Inter-Varsity Debate', '2026-05-10', 'Intellectual battles.', 'Dewan Pembangunan Siswa', '09:00', '17:00', '2026-05-12', 150, 'competition', 140, '50000000-0000-0000-0000-000000000014', '[]'::jsonb, '2026-05-05', '{}'),
('20000000-0000-0000-0000-000000000014', 'Charity Run 2025', '2026-06-01', 'Run for a cause.', 'Padang Kawad', '07:00', '11:00', '2026-06-01', 1000, 'sport', 850, '50000000-0000-0000-0000-000000000015', '[]'::jsonb, '2026-05-25', '{}'),
('20000000-0000-0000-0000-000000000015', 'Traditional Dance Workshop', '2026-03-20', 'Learn traditional dances.', 'Dewan Budaya', '14:00', '17:00', '2026-03-20', 50, 'workshop', 45, '50000000-0000-0000-0000-000000000016', '[]'::jsonb, '2026-03-15', '{}'),
('20000000-0000-0000-0000-000000000016', 'Mobile App Dev Workshop', '2026-02-10', 'Build your first app.', 'Computer Lab 2', '09:00', '16:00', '2026-02-10', 40, 'workshop', 38, '50000000-0000-0000-0000-000000000017', '[]'::jsonb, '2026-02-05', '{}'),
('20000000-0000-0000-0000-000000000017', 'Engineering Career Talk', '2026-03-05', 'Meet engineers from industry.', 'DK 2', '14:00', '16:00', '2026-03-05', 150, 'talk', 120, '50000000-0000-0000-0000-000000000018', '[]'::jsonb, '2026-03-01', '{}'),
('20000000-0000-0000-0000-000000000018', 'Music Festival', '2026-07-15', 'Live music performances.', 'Padang Kawad', '18:00', '23:00', '2026-07-15', 2000, 'cultural', 1500, '50000000-0000-0000-0000-000000000019', '[]'::jsonb, '2026-07-10', '{}'),
('20000000-0000-0000-0000-000000000019', 'Chess Tournament', '2026-04-15', 'Strategy and focus.', 'Foyer SKK', '08:00', '18:00', '2026-04-15', 64, 'competition', 60, '50000000-0000-0000-0000-000000000020', '[]'::jsonb, '2026-04-10', '{}'),
('20000000-0000-0000-0000-000000000020', 'Beach Clean Up', '2026-05-20', 'Community service.', 'Pantai Bersih', '08:00', '12:00', '2026-05-20', 100, 'social', 80, '50000000-0000-0000-0000-000000000021', '[]'::jsonb, '2026-05-15', '{}');
